...
item("", 0)
item("Tent", 100)
item("Sleeping Bag", 40)
item("Sleeping Pad", 15)
price = tk.IntVar()
...
priceLable.place(relx=.86, rely=.4,relwidth=.08, relheight=.05)
####THIS NEEDS TO BE FIXED TO DISPLAY THE ACTUAL PRICE####
...
button25 = tk.Button(frame, text="Update Price",font='Helvetica 12', bg='light gray', fg='black',command = getPrice)
button25.place(relx=.6, rely=.45,relwidth=.2, relheight=.05)
...
R1.place(relx=.3, rely=.1075,relwidth=.2, relheight=.042)
